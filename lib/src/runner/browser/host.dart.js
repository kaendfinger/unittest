// Generated by dart2js, the Dart to JavaScript compiler version: 1.9.0-edge.43891.
...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 26, 27],
  ...
  }, "call$5", "_rootHandleUncaughtError$closure", 10, 0, 28],
  ...
  }, "call$4", "_rootRun$closure", 8, 0, 29],
  ...
  }, "call$5", "_rootRunUnary$closure", 10, 0, 30],
  ...
  _rootFork: [function($self, $parent, zone, specification, zoneValues) {
    ...
    return t1;
  }, "call$5", "_rootFork$closure", 10, 0, 40],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 26, 27],
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 41],
...
["dart.convert", "dart:convert", , P, {
  ...
  }, "call$1", "_defaultToEncodable$closure", 2, 0, 43],
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:13;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.core", "dart:core", , P, {
  ...
  Uri: {
    ...
    _merge$2: function(base, reference) {
      ...
      return C.JSString_methods.substring$2(base, 0, baseEnd + 1) + C.JSString_methods.substring$1(reference, refStart - 3 * backCount);
    },
...
["unittest.browser_host", "browser_host.dart", , Y, {
  "^": "",
  main: [function() {
    P.runZoned(new Y.main_closure(), new Y.main_closure0(), null, null);
  }, "call$0", "main$closure", 0, 0, 1],
  _connectToServer: function() {
    var currentUrl, t1, targetScheme, targetUserInfo, targetHost, targetPort, targetPath, targetQuery, t2, fragment, scheme, isFile, port, host, path, query, webSocket, inputController, outputController;
    ...
    t1 = P.Uri_parse(J.$index$asx(t1._collection$_map, "managerUrl"));
    ...
    if (targetScheme.length !== 0) {
      ...
      targetPath = currentUrl._removeDotSegments$1(t1._path);
      ...
      targetScheme = currentUrl.scheme;
      if (t1._host != null) {
        targetUserInfo = t1._userInfo;
        targetHost = t1.get$host(t1);
        ...
        t2 = t1._path;
        if (t2 === "") {
          targetPath = currentUrl._path;
          targetQuery = t1._query;
          if (targetQuery != null)
            ;
          else
            targetQuery = currentUrl._query;
        } else {
          targetPath = C.JSString_methods.startsWith$1(t2, "/") ? currentUrl._removeDotSegments$1(t2) : currentUrl._removeDotSegments$1(currentUrl._merge$2(currentUrl._path, t2));
          targetQuery = t1._query;
          if (targetQuery != null)
            ;
          else
        ...
        targetUserInfo = currentUrl._userInfo;
        targetHost = currentUrl._host;
        targetPort = currentUrl._port;
      }
    }
    ...
    if (fragment != null)
      ...
      fragment = null;
    t1 = new P.Uri(targetHost, targetPort, targetPath, targetScheme, targetUserInfo, targetQuery, fragment, null, null);
    scheme = P.Uri__makeScheme("ws", 2);
    isFile = scheme === "file";
    port = P.Uri__makePort(targetPort, scheme);
    if (targetHost != null)
      host = t1.get$host(t1);
    else
      host = targetUserInfo.length !== 0 || port != null || isFile ? "" : null;
    if (!isFile)
      t1 = host != null && targetPath.length !== 0;
    else
      t1 = true;
    path = t1 && !C.JSString_methods.startsWith$1(targetPath, "/") ? "/" + targetPath : targetPath;
    if (targetQuery != null)
      query = targetQuery;
    else
      query = null;
    if (fragment != null)
      ...
      fragment = null;
    webSocket = W.WebSocket_WebSocket(new P.Uri(host, port, path, scheme, targetUserInfo, query, fragment, null, null).toString$0(0), null);
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new Y._connectToServer_closure(inputController)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    outputController = P.StreamController_StreamController(null, null, null, null, true, null);
    H.setRuntimeTypeInfo(new P._ControllerStream(outputController), [null]).listen$1(new Y._connectToServer_closure0(webSocket));
  ...
  _connectToIframe: function(url) {
    ...
    t1.get$first(t1).then$1(new Y._connectToIframe_closure(iframe, inputController, outputController));
  ...
  main_closure: {
    "^": "Closure:0;",
    call$0: function() {
      var serverChannel = Y._connectToServer();
      H.setRuntimeTypeInfo(new P._ControllerStream(serverChannel._inputController), [null]).listen$1(new Y.main__closure(serverChannel));
    }
  },
  main__closure: {
    "^": "Closure:2;serverChannel_0",
    call$1: function(message) {
      var t1, subChannel, iframeChannel;
      t1 = J.getInterceptor$asx(message);
      subChannel = this.serverChannel_0.createSubChannel$1(t1.$index(message, "channel"));
      iframeChannel = Y._connectToIframe(t1.$index(message, "url"));
      iframeChannel.input.listen$1(new Y.main___closure(subChannel));
      subChannel.input.listen$1(new Y.main___closure0(iframeChannel));
    }
  },
  main___closure: {
    "^": "Closure:2;subChannel_1",
    call$1: function(data) {
      var t1 = this.subChannel_1.output._async$_target;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t1._async$_add$1(data);
    }
  ...
  main___closure0: {
    "^": "Closure:2;iframeChannel_2",
    call$1: function(data) {
      var t1 = this.iframeChannel_2.output._async$_target;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t1._async$_add$1(data);
    }
  ...
  _connectToServer_closure0: {
    ...
    call$1: function(message) {
      this.webSocket_1.send(C.JsonCodec_null_null.encode$1(message));
    }
  },
  _connectToIframe_closure: {
    ...
    call$1: function(_) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new Y._connectToIframe__closure(this.inputController_1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      H.setRuntimeTypeInfo(new P._ControllerStream(this.outputController_2), [null]).listen$1(new Y._connectToIframe__closure0(t1));
    }
  },
  _connectToIframe__closure: {
    "^": "Closure:2;inputController_3",
    call$1: function(message) {
      var t1, t2;
      t1 = J.getInterceptor$x(message);
      t1.stopPropagation$0(message);
      t2 = this.inputController_3;
      t1 = t1.get$data(message);
      if (t2._state >= 4)
  ...
  _connectToIframe__closure0: {
    "^": "Closure:2;iframe_4",
    call$1: function(message) {
      J.postMessage$2$x(W._convertNativeToDart_Window(this.iframe_4.contentWindow), message, J.get$origin$x(window.location));
    }
  }
},
1],
["unittest.multi_channel", "multi_channel.dart", , K, {
  "^": "",
  _MultiChannel: {
    "^": "Object;_innerInput,_innerOutput,_inputController,_outputController,_inputs,_nextId",
    createSubChannel$1: function(id) {
      var t1, inputId, t2, inputController, outputController;
      t1 = {};
      t1.outputId_0 = null;
      if (id != null) {
        t1.outputId_0 = H.intTypeCast(id) + 1;
        inputId = id;
      } else {
        t2 = this._nextId;
        inputId = t2 + 1;
      ...
      inputController = P.StreamController_StreamController(null, null, null, null, true, null);
      outputController = P.StreamController_StreamController(null, null, null, null, true, null);
      this._inputs.$indexSet(0, inputId, H.setRuntimeTypeInfo(new P._StreamSinkWrapper(inputController), [H.getRuntimeTypeArgument(inputController, "_StreamController", 0)]));
      H.setRuntimeTypeInfo(new P._ControllerStream(outputController), [null]).listen$1(new K._MultiChannel_createSubChannel_closure(t1, this));
      return new K.SubChannel(this, t1.outputId_0, H.setRuntimeTypeInfo(new P._ControllerStream(inputController), [null]), H.setRuntimeTypeInfo(new P._StreamSinkWrapper(outputController), [H.getRuntimeTypeArgument(outputController, "_StreamController", 0)]));
    },
    _MultiChannel$2: function(_innerInput, _innerOutput) {
      var t1 = this._inputController;
      this._inputs.$indexSet(0, 0, H.setRuntimeTypeInfo(new P._StreamSinkWrapper(t1), [H.getRuntimeTypeArgument(t1, "_StreamController", 0)]));
      H.setRuntimeTypeInfo(new P._ControllerStream(this._outputController), [null]).listen$1(new K._MultiChannel_closure(this));
      this._innerInput.listen$1(new K._MultiChannel_closure0(this));
    },
    static: {_MultiChannel$: function(_innerInput, _innerOutput) {
        var t1 = new K._MultiChannel(_innerInput, _innerOutput, P.StreamController_StreamController(null, null, null, null, true, null), P.StreamController_StreamController(null, null, null, null, true, null), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, P.StreamSink), 1);
        t1._MultiChannel$2(_innerInput, _innerOutput);
        return t1;
      }}
  },
  _MultiChannel_closure: {
    "^": "Closure:2;this_0",
    call$1: function(message) {
      var t1 = this.this_0._innerOutput._async$_target;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
  ...
  _MultiChannel_closure0: {
    ...
    call$1: function(message) {
      var t1, sink;
      t1 = J.getInterceptor$asx(message);
      sink = this.this_1._inputs.$index(0, t1.$index(message, 0));
      if (sink != null)
        J.add$1$ax(sink, t1.$index(message, 1));
    }
  },
  _MultiChannel_createSubChannel_closure: {
    "^": "Closure:2;box_0,this_1",
    call$1: function(message) {
      var t1, t2;
      t1 = this.box_0.outputId_0;
      t2 = this.this_1._innerOutput._async$_target;
      if (t2._state >= 4)
        H.throwExpression(t2._badEventState$0());
      t2._async$_add$1([t1, message]);
    }
  },
  SubChannel: {
    "^": "Object;_parent,id,input,output"
  }
}],
["unittest.stream_channel", "stream_channel.dart", , X, {
  "^": "",
  StreamChannel: {
    "^": "Object;input,output"
  }
...
//# sourceMappingURL=browser_host.dart.js.map
